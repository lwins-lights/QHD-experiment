...
const double lb[] = {-25};   // lower bound of the actual function range for each dimension
const double ub[] = {25};     // upper bound
const double compress_coef = 0.95;  // the actual function will be compressed into a hypercube "bound": (compress_coef * [-L,L])^dim
const double slope = 1000000000;             // specifies how fast the encapsulated function will grow out of the "bound"
